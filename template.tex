...
\BLOCK{ endif }
\figureSeriesRow{
\figureSeriesElement{\BLOCK{ if filename_captions }\theverbbox\BLOCK{ endif }}{\includegraphics[width=\textwidth,keepaspectratio]{\VAR{figpdf}}}
}
\BLOCK{ endfor }
\pagebreak
...
%# TODO copy verbbox filename_caption handling from above to this loop too
